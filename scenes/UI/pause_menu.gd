...
func _unhandled_input(event):
	if event.is_action_pressed("pause"):
		close()
		get_tree().root.set_input_as_handled() # nothing else will handle this event
...
func on_options_pressed():
	...
	options_menu_instance.back_pressed.connect(on_options_back_button_pressed.bind(options_menu_instance))


func on_options_back_button_pressed(options_menu: Node):
